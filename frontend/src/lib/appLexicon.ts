...
export const appLexicon: AppLexicon = {
  ...
  financeBannerBody: "",
  financePageIntro:
    "Обзор, учёт, бухгалтерия (расходы и Gmail), дебиторка по этапам оплат, склад и отчёты ОПУ/ОСВ/ДДС. Доступ: владелец, админ, бухгалтер, супер-владелец; финансовый аналитик — просмотр без изменений.",
  navKanban: "Канбан",
