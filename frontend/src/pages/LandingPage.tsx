...
const shots = [
  ...
  { src: "/landing/11-analytics-funnel.png", title: "Аналитика по направлениям" },
  { src: "/landing/12-crm-settings.png", title: "Настройки направления" },
...
const platformTabs = [
  {
    ...
    bullets: [
      ...
      "Гибкая настройка направлений, источников, стадий и ответственных",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Форма новой записи с контролем направления и ответственных",
    ],
  },
  {
    id: "kpi",
    ...
    bullets: [
      ...
      "Аналитика по направлениям, менеджерам и закрытым сделкам",
...
const targetGroups = [
  ...
  },
  {
    ...
    text: "Компании с несколькими менеджерами и направлениями, где важно масштабировать направления и контроль KPI.",
  },
  {
...
const featureCatalogBadges: Array<{ label: string; Icon: ComponentType<{ className?: string }> }> = [
  { label: "CRM и направления", Icon: Funnel },
...
const faq = [
  ...
  },
  {
    ...
    a: "Да. Настраиваются направления, стадии, источники лидов, роли, интеграции и отчеты под вашу структуру работы.",
  },
  {
    q: "Как быстро запустить?",
    a: "Базовый запуск занимает 1-2 дня: подключение каналов, настройка направлений, обучение команды и старт работы.",
  },
];
        ...
        <div className="mo-section rounded-3xl bg-gradient-to-r from-[#f7f2e8] via-white to-[var(--mo-surface)] p-7">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-[var(--mo-border)] bg-[var(--mo-surface)] p-4">
              ...
              <p className="mt-2 text-sm mo-muted">Фиксируем текущую направление, роли, каналы и точки потерь.</p>
            </div>
            <div className="rounded-2xl border border-[var(--mo-border)] bg-[var(--mo-surface)] p-4">
