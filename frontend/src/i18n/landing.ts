...
const dict = {
  en: {
    ...
    demosMoreLive: "More live sandboxes",
  ...
  ru: {
    ...
    ctaOffer: "Записаться на разговор",
    ...
    demosPageLead:
      "Откройте работающий продукт в один клик. Только тестовые данные — не прод клиентов.",
    demosLiveTitle: "Можно открыть сейчас",
    demosLiveLead: "Вход без пароля в рабочие системы.",
    demosMoreLive: "Ещё живые песочницы",
    demosShowcaseTitle: "Обзоры",
    demosShowcaseLead: "Проход по интерфейсу, когда полный публичный sandbox ещё не выведен.",
