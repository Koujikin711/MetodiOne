...
const dict = {
  en: {
    ...
    demosShowcaseTitle: "Showcases",
    demosShowcaseLead: "Walkthrough UIs when a full sandbox host is not public yet.",
  ...
  ru: {
    ...
    demosPageTitle: "Живые демо",
    demosPageLead:
      "Откройте работающий продукт в один клик. Только sandbox-данные — не прод клиентов.",
    demosLiveTitle: "Можно открыть сейчас",
    demosLiveLead: "Вход без пароля в рабочие системы.",
    demosShowcaseTitle: "Showcase",
    demosShowcaseLead: "Проход по UI, когда публичный sandbox ещё не выведен.",
