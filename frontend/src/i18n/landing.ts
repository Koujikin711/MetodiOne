...
const dict = {
  en: {
    ...
    productsLead: "A portfolio of systems we designed, built and can deliver for you.",
    openDemo: "Open demo",
  ...
  ru: {
    ...
    productsLead: "Портфолио систем, которые мы спроектировали, собрали и можем поставить вам.",
